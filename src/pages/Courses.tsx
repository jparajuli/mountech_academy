...
import { 
  ...
  Plus, Trash2, BookOpen, Sparkles, DollarSign, Award, Compass, ChevronLeft
} from 'lucide-react';
import { 
                  ...
                  <div className="bg-white border border-[#e5e7eb] rounded-2xl shadow-sm p-6 space-y-6 animate-fade-in" id="course-provisioner-form-card">
                    ...
                    <form onSubmit={handleCreateCourseSubmit} className="space-y-6 text-xs">
                      ...
                      <div className="border-t border-gray-100 pt-5 flex items-center justify-end gap-3 font-sans">
                        <button
                          type="button"
                          onClick={() => setShowCreateCourseSection(false)}
                        ...
                        <button
                          ...
                          className="px-5 py-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 disabled:cursor-not-allowed rounded-lg shadow-xs transition-all flex items-center gap-1 cursor-pointer"
                        >
                          {creatingCourse ? (
                            <>
