...
import { getUsers, getEnrollments, updateRole, getAuditLogs, getStudentsOverview } from "../controllers/adminController.js";
...
router.get("/students/overview", requireAuth, requireRole(["admin"]), getStudentsOverview);
